...
#define CUSTOM_MACHINE_NAME "Ender-3-V2-UBL-Sprite"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 415.75 }  // Ender Configs   // 3VD
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -45, -30, 0 }  // MRiscoC BLTouch offset for support: https://www.thingiverse.com/thing:4605354 (z-offset = -1.80 mm)
...
#define Z_PROBE_LOW_POINT          -2 // 3VD  // (mm) Farthest distance below the trigger-point to go before stopping  // MRiscoC allows reach lower points
...
#define Z_AFTER_HOMING         10   // (mm) Height to move to after homing (if Z was homed)  // MRiscoC Crearance over the bed  // 3VD
...
#define FILAMENT_RUNOUT_SENSOR  // MRiscoC Enabled runout sensor support
  ...
  #define FILAMENT_RUNOUT_DISTANCE_MM 10  // MRiscoC Customizable by menu   // 3VD
...
#define PREHEAT_BEFORE_LEVELING  // MRiscoC Heatting to compensate thermal expansions
  ...
  #define LEVELING_NOZZLE_TEMP   185   // (°C) Only applies to E0 at this time  // MRiscoC No necessary for BLTouch   // 3VD
  #define LEVELING_BED_TEMP     60    // 3VD
#endif
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define GRID_MAX_POINTS_X 4   // 3VD  // Don't use more than 15 points per axis, implementation limited.  // MRiscoC Customizable by menu
  #define GRID_MAX_POINTS_Y GRID_MAX_POINTS_X
  ...
  #define UBL_SAVE_ACTIVE_ON_M500   // Save the currently active mesh in the current slot on M500  // Disabled for AML compatibility    // 3VD
